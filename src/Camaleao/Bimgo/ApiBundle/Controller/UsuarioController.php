...
class UsuarioController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $produto = new Usuario();
        $form = $this->createForm('Camaleao\Bimgo\CoreBundle\Form\UsuarioType', $produto);
    ...
    public function editAction(Request $request, Usuario $produto)
    {
        ...
        $form = $this->createForm('Camaleao\Bimgo\CoreBundle\Form\UsuarioType', $produto, array('method' => $request->getMethod()));
        $form->handleRequest($request);
