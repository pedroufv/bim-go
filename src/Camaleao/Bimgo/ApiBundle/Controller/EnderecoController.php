...
class EnderecoController extends Controller implements ApiController
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $list = $em->getRepository('CamaleaoBimgoCoreBundle:Endereco')->findBy($criteria, $order, $limit, $offset);
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Camaleao\Bimgo\CoreBundle\Form\EnderecoType', $endereco, $options);
