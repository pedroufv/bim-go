...
use Camaleao\Bimgo\CoreBundle\Entity\Funcionario;
...
class FuncionarioController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $list = $em->getRepository('CamaleaoBimgoCoreBundle:Funcionario')->findByPublicada($criteria, $order, $limit, $offset);
    ...
    public function editAction(Request $request, Funcionario $funcionario)
    {
        ...
        $form = $this->createForm('Camaleao\Bimgo\CoreBundle\Form\FuncionarioType', $funcionario, array('method' => $request->getMethod()));
        $form->handleRequest($request);
