...
use Camaleao\Bimgo\CoreBundle\Entity\Pontuacao;
 ...
 * @Route("/pontuacoes")
 */
class PontuacaoController extends ApiController
{
    /**
     * List all Pontuacao entities
     *
     * @param Request $request
     * @return Response
     *
     * @Route(name="api_v1_pontuacoes_index")
     * @Method("GET")
     */
    public function indexAction(Request $request)
    {
        ...
        $list = $em->getRepository('CamaleaoBimgoCoreBundle:Pontuacao')->findBy($criteria, $order, $limit, $offset);
    ...
    /**
     * Creates a new Pontuacao entity
     *
     * @param Request $request
     * @return Response
     *
     * @Route(name="api_v1_pontuacoes_new")
     * @Method("POST")
     */
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Camaleao\Bimgo\CoreBundle\Form\PontuacaoType', $pontuacao, $options);
        ...
        $responseContent = $serializer->serialize($pontuacao, 'json');
        $response->setContent($responseContent);
    ...
    /**
     * List Pontuacao entities of enterprises
     *
     * @param Request $request
     * @return Response
     *
    ...
    /**
     * List Pontuacao entities of user in one city
     *
     * @param Request $request
     * @return Response
     *
    ...
    public function institutionsFollowedInTheCityAction(Request $request)
    {
        ...
        $list = $em->getRepository('CamaleaoBimgoCoreBundle:Pontuacao')->findByCidade($criteria, $order, $limit, $offset);
