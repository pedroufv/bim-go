 ...
 * @Route("/papeis")
 */
class PapelController extends ApiController
{
    /**
     * Lists Papel
     *
     ...
     * @return Response
     *
     * @Route(name="api_v1_papeis_index")
     * @Method("GET")
     */
    public function indexAction(Request $request)
    {
        ...
        $list = $em->getRepository('CamaleaoBimgoCoreBundle:Papel')->findBy($criteria, $order, $limit, $offset);
