...
class InstituicaoController extends Controller
{
    ...
    public function promocoesAction(Request $request)
    {
        ...
        $list = $em->getRepository('CamaleaoWebBimgoBundle:Promocao')->findBy($criteria, $order, $limit, $offset);
    ...
    public function funcionariosAction(Request $request)
    {
        ...
        $list = $em->getRepository('CamaleaoWebBimgoBundle:Funcionario')->findBy($criteria, $order, $limit, $offset);
