...
use Camaleao\Web\BimgoBundle\Entity\Contato;
...
class ContatoController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $list = $em->getRepository('CamaleaoWebBimgoBundle:Contato')->findByPublicada($criteria, $order, $limit, $offset);
    ...
    public function newAction(Request $request)
    {
        ...
        $contato = new Contato();
        $form = $this->createForm('Camaleao\Web\BimgoBundle\Form\ContatoType', $contato);
    ...
    public function editAction(Request $request, Contato $contato)
    {
        ...
        $form = $this->createForm('Camaleao\Web\BimgoBundle\Form\ContatoType', $contato, array('method' => $request->getMethod()));
        $form->handleRequest($request);
