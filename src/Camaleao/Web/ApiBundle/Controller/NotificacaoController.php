...
class NotificacaoController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $list = $em->getRepository('CamaleaoWebBimgoBundle:Notificacao')->findByPublicada($criteria, $order, $limit, $offset);
    ...
    public function editAction(Request $request, Notificacao $notificacao)
    {
        ...
        $form = $this->createForm('Camaleao\Web\BimgoBundle\Form\NotificacaoType', $notificacao, array('method' => $request->getMethod()));
        $form->handleRequest($request);
