...
class EnderecoController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $list = $em->getRepository('CamaleaoWebBimgoBundle:Endereco')->findByPublicada($criteria, $order, $limit, $offset);
    ...
    public function editAction(Request $request, Endereco $endereco)
    {
        ...
        $form = $this->createForm('Camaleao\Web\BimgoBundle\Form\EnderecoType', $endereco, array('method' => $request->getMethod()));
        $form->handleRequest($request);
