...
class Cidade
{
     ...
     * Set estado
     *
     * @param \Camaleao\Web\BimgoBundle\Entity\Estado $estado
     * @return Cidade
     */
    public function setEstado(\Camaleao\Web\BimgoBundle\Entity\Estado $estado = null)
    {
        $this->estado = $estado;
     ...
     * Get estado
     *
     * @return \Camaleao\Web\BimgoBundle\Entity\Estado 
     */
