...
use Camaleao\Web\BimgoBundle\Entity\Cliente;
use Camaleao\Web\BimgoBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    {
        $cliente = new Cliente();
        $form = $this->createForm('Camaleao\Web\BimgoBundle\Form\ClienteType', $cliente);
    ...
    {
        $deleteForm = $this->createDeleteForm($cliente);
        $editForm = $this->createForm('Camaleao\Web\BimgoBundle\Form\ClienteType', $cliente);
